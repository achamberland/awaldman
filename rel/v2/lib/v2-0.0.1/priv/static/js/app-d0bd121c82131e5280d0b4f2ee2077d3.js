...
var _header = require("web/static/js/layout/header");

var _header2 = _interopRequireDefault(_header);

var _booking = require("web/static/js/layout/booking");

var _booking2 = _interopRequireDefault(_booking);

var _shows = require("web/static/js/layout/shows");
...
;require.register("web/static/js/common/chaplin.js", function(exports, require, module) {
"use strict";
 ...
 */
var Chaplin = {
    replaceTemplateStrings: function replaceTemplateStrings(element, data) {
        var template = typeof element === 'string' ? element : (0, _jquery2.default)(element).html();
        var search = /\{\{.+?\}\}/g;
...
exports.default = Chaplin;
});

require.register("web/static/js/common/time.js", function(exports, require, module) {
'use strict';
...
var Clock = exports.Clock = {
    ...
    getHumanTime: function getHumanTime(date) {
    ...
    getTimezoneOffset: function getTimezoneOffset(dateString) {
...
var Calendar = exports.Calendar = {
    getMonthShort: function getMonthShort(date) {
        var monthNames = ["Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sept", "Oct", "Nov", "Dec"];
        var monthNum = date.getMonth();
        return monthNames[monthNum];
    },

    getDateFromTimestamp: function getDateFromTimestamp(dateString) {
...
require.register("web/static/js/layout/booking.js", function(exports, require, module) {
"use strict";
...
var Booking = {
    ...
    init: function init(Clipboard) {
        this.Clipboard = Clipboard;

        this.bookingLink = (0, _jquery2.default)("#booking-trigger");
        this.bookingForm = (0, _jquery2.default)("#booking-info");
        this.phoneClipboardButton = (0, _jquery2.default)("#phone-clipboard");
        this.emailClipboardButton = (0, _jquery2.default)("#email-clipboard");
        this.allClipboardButtons = (0, _jquery2.default)(this.phoneClipboardButton).add(this.emailClipboardButton);
    ...
    handleBookingLinkClick: function handleBookingLinkClick(event) {
        var self = this;
        this.bookingLink.addClass("active");
        event.stopPropagation();

        (0, _jquery2.default)('body').one("click", function (newEvent) {
            self.handleClickWhileBookingActive(newEvent);
        });
    },

    handleClickWhileBookingActive: function handleClickWhileBookingActive(event) {
        var self = this;
        var isTargetBookingForm = (0, _jquery2.default)(event.target).closest("#booking-info").length;
        event.stopPropagation();
...
require.register("web/static/js/layout/config.js", function(exports, require, module) {
"use strict";
...
require.register("web/static/js/layout/header.js", function(exports, require, module) {
"use strict";
...
var Header = {
    ...
    init: function init() {
        ...
        this.mobileNavToggle = (0, _jquery2.default)('#header-links-toggle');
    ...
    setTriggerPositions: function setTriggerPositions() {
        this.changeTriggers = [{
            "klass": "homeContentOverlap",
            "yThreshold": (0, _jquery2.default)("#home-container").offset().top
        }, {
            "klass": "showsPageOverlap",
            "yThreshold": (0, _jquery2.default)("#shows").offset().top - this.height
        }];
    ...
    setMobileMenuEvents: function setMobileMenuEvents() {
        (0, _jquery2.default)(this.mobileNavToggle).click(this.handleMobileMenuClick.bind(this));
        (0, _jquery2.default)(this.pageLinks).click(this.hideMobileMenu.bind(this));
    },

    handleMobileMenuClick: function handleMobileMenuClick(event) {
        event.stopPropagation();
    ...
    showMobileMenu: function showMobileMenu(event) {
        var self = this;
    ...
    hideMobileMenu: function hideMobileMenu(event) {
        this.element.removeClass("show-mobile-nav");
    },

    handleActiveMenuClick: function handleActiveMenuClick(event) {
        var self = this;
        var isTargetHeader = (0, _jquery2.default)(event.target).closest("#header").length;
        event.stopPropagation();
        if (!isTargetHeader) {
...
require.register("web/static/js/layout/shows.js", function(exports, require, module) {
"use strict";
...
var _config = require("web/static/js/layout/config");

var _config2 = _interopRequireDefault(_config);

var _chaplin = require("web/static/js/common/chaplin");

var _chaplin2 = _interopRequireDefault(_chaplin);

var _time = require("web/static/js/common/time");
...
var Shows = {
    ...
    formatShowData: function formatShowData(show) {
        var data = {};
        ...
        if (this.getHasFullAddress(show)) {
            data.mapLink = mapLinkRoot + 'place/' + encodeURIComponent((data.placeName ? data.placeName + ', ' : '') + (location.street ? location.street + ', ' : '') + (location.city && location.state ? location.city + ', ' : '') + (location.city && location.state ? location.state + ', ' : '') + (location.zip ? location.zip : ''));
            ...
            data.mapLink = mapLinkRoot + '?q=' + encodeURIComponent(location.latitude + ',' + location.longitude);
        } else {
            data.mapLinkClass = 'hide';
        }

        if (show.end_time) {
            data.date = _time.Calendar.getDateFromTimestamp(show.end_time);
            data.endTime = _time.Clock.getHumanTime(data.date);
        }
        if (show.start_time) {
            data.date = _time.Calendar.getDateFromTimestamp(show.start_time);
            data.startTime = _time.Clock.getHumanTime(data.date);
            data.startDateString = data.date.toDateString();
        }

        data.timeRange = _time.Clock.getTimeRange(data.startTime, data.endTime);

        data.day = data.date.getDate();
        data.month = _time.Calendar.getMonthShort(data.date);

        data.pastShowFlag = show.alreadyHappened && _config2.default.grey_past_shows ? 'pastShow' : '';

        data.title = show.name;
        data.title = show.name;

        return _jquery2.default.extend({}, show, data);
    },

    getHasFullAddress: function getHasFullAddress(show) {
        return show.place && show.place.location && show.place.location.street && show.place.location.state && show.place.location.city && show.place.location.zip && true;
    },
    getHasCoordinates: function getHasCoordinates(show) {
        return show.place && show.place.location && show.place.location.latitude && show.place.location.longitude && true;
    },

    getShowListHeight: function getShowListHeight() {
        var showItems = (0, _jquery2.default)('#shows-components').children();
        var height = 0;
        if (showItems && showItems.length) {
            showItems.each(function (i, item) {
                height = height + (0, _jquery2.default)(item).height();
            });
        }
        return height;
    },
    ...
    render: function render() {
        ...
        var template = (0, _jquery2.default)('#showTemplate');
        var descriptionMaxHeight = _config2.default.collapse_long_show_descriptions ? 36 : 9999;
        var limit = Math.min(shows.length, _config2.default.max_shows_to_display);

        for (var i = 0; i < limit; i++) {
            // Check if show already happened
            var comparableTime = shows[i].end_time ? _time.Calendar.getDateFromTimestamp(shows[i].end_time) : shows[i].start_time ? _time.Calendar.getDateFromTimestamp(shows[i].start_time) : new Date();

            shows[i].alreadyHappened = comparableTime < new Date();

            if (_config2.default.show_upcoming_shows_only && shows[i].alreadyHappened) {
                continue;
            }

            var formattedData = this.formatShowData(shows[i]);
            var formattedTemplate = _chaplin2.default.replaceTemplateStrings(template.clone(), formattedData);
            var element = (0, _jquery2.default)(formattedTemplate);

            (0, _jquery2.default)('#shows-components').append(element);

            var totalHeight = this.getShowListHeight();
            var containerHeight = (0, _jquery2.default)('#shows-components').height();
            if (totalHeight < containerHeight) {
                (0, _jquery2.default)('#shows-components').addClass('no-scroll');
            }
        ...
        if (!(0, _jquery2.default)("#shows-components").children() || !(0, _jquery2.default)("#shows-components").children().length) {
            (0, _jquery2.default)("#no-shows").removeClass("hide");
        }
    },

    attachRenderEvents: function attachRenderEvents(element, data) {
        element.on('click', function (event) {
            document.href = data.eventLink;
        });

        (0, _jquery2.default)('#shows-components').on('scroll', function (event) {
            if ((0, _jquery2.default)(event.currentTarget).scrollTop() > 10) {
                (0, _jquery2.default)(event.currentTarget).parent().addClass('scrolledShows');
            } else {
                (0, _jquery2.default)(event.currentTarget).parent().removeClass('scrolledShows');
            }
        });
    },

    attachPageLoadEvents: function attachPageLoadEvents() {
        (0, _jquery2.default)('body').on('click', '.description-more, .eventDescription', function (event) {
            (0, _jquery2.default)(event.currentTarget).parents('.showItem').removeClass('collapsed-description');
        });
    }
};
...
require.register("web/static/js/patSajax.js", function(exports, require, module) {
'use strict';
